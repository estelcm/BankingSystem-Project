...
import com.ironhack.BankingSystem.filters.CustomAuthenticationFilter;
import com.ironhack.BankingSystem.filters.CustomAuthorizationFilter;
...
public class SecurityConfig {
    ...
    protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((requests) -> requests
                ...
                //ADMIN
                .requestMatchers(POST, "/create_account_holder").hasAnyAuthority("ROLE_ADMIN")
                .requestMatchers(POST, "/create_checking_account").hasAnyAuthority("ROLE_ADMIN")
                .requestMatchers(POST, "/create_savings_account").hasAnyAuthority("ROLE_ADMIN")
                .requestMatchers(POST, "/create_credit_card_account").hasAnyAuthority("ROLE_ADMIN")
                .requestMatchers(GET, "/check_balance").hasAnyAuthority("ROLE_ADMIN")
                .requestMatchers(PATCH, "/update_account/{accountId}").hasAnyAuthority("ROLE_ADMIN")
                .requestMatchers(DELETE, "/delete_account/{accountId}").hasAnyAuthority("ROLE_ADMIN")
                .requestMatchers(POST, "/create_third_party").hasAnyAuthority("ROLE_ADMIN")

                //ACCOUNTHOLDER
                .requestMatchers(GET, "/get_balance").hasAnyAuthority("ROLE_ACCOUNTHOLDER")
                .requestMatchers(POST, "/create_transaction").hasAnyAuthority("ROLE_ACCOUNTHOLDER")
